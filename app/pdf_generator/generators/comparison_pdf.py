...
class ComparisonPDF(PDFGenerator):
    def print_player_info(self):
        ...
        """
        self._pdf.image('app/pdf_generator/resources/images/placeholder_player_photo.jpg', 10, 70, 60, 60)
        self._pdf.image('app/pdf_generator/resources/images/Foto william Troost-Ekong.jpeg', 10, 180, 60, 60)
