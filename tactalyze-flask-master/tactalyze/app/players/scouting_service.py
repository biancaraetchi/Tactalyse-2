...
def run(filestream, dates,end_date, dir):
    ...
    try:
        ...
        end_index = nearest_ind(stats_per90['Date'], datetime.date(end_date.year, end_date.month, end_date.day))
    except ValueError:
        dates = None
    ...
    if year_frame == 3:
        season_index = nearest_ind(stats_per90['Date'], datetime.date(current_date.year - 3, 6, 1))
        season_index1 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year - 2, 6, 1))
        season_index2 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year - 1, 6, 1))
        season_index3 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year, 6, 1))
        season_index4 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year, current_date.month, current_date.day))
        season_index5 = 0
        ...
        season_index = nearest_ind(stats_per90['Date'], datetime.date(current_date.year - 4, 6, 1))
        season_index1 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year - 3, 6, 1))
        season_index2 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year - 2, 6, 1))
        season_index3 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year - 1, 6, 1))
        season_index4 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year, 6, 1))
        season_index5 = nearest_ind(stats_per90['Date'], datetime.date(current_date.year, current_date.month, current_date.day))
    ...
    # If 4 years were selected, all games that re not in the 3 year period will be removed
        ...
        if season_index1 > 0:
            stats_per90 = stats_per90[season_index - 4: season_index5 + 4]
    ...
    for column in list(stats_per90.columns[9:]):
        ...
        if year_frame == 3:
            ...
            ax.axvline(x=season_index3, color='gray', linestyle='--')  # marks end of current_year 
        ...
        if year_frame == 4:
            ...
            ax.axvline(x=season_index4, color='gray', linestyle='--')  # marks end of current_year
        ...
        if year_frame == 3:
            ...
            plt.xticks([(season_index+season_index1)/2, (season_index2+season_index1)/2, (season_index2+season_index3)/2, (season_index3+season_index4)/2], season_ticks3)

        if year_frame == 4:
            # Customize minor tick labels
            plt.xticks([(season_index+season_index1)/2, (season_index2+season_index1)/2, (season_index2+season_index3)/2, (season_index3+season_index4)/2, (season_index4+season_index5)/2], season_ticks4)
